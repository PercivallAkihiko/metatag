...
contract MetaTagTest is DSTest {
    ...
    function testAddVideo() public {
       ...
       //}
        ...
        vm.startPrank(user2);
        tag.submitHash(company, 12, 0x1805afed249afb4a6323ce17840f0cfd413f9fb314e5b95981d9482749f936a1);
        vm.stopPrank();
        ...
        vm.startPrank(user2);
        uint256[] memory inputArray2 = new uint256[](8);
        inputArray2[0] = 1;
        inputArray2[1] = 2;
        inputArray2[2] = 3;
        inputArray2[3] = 4;
